...
const Logo = () => {
    ...
    const linkTarget = isAuthenticated ? '/dashboard' : '/landing';

    return (
        <Link to={linkTarget} className="flex items-center gap-3 group">
            ...
            <div>
                ...
                {process.env.REACT_APP_COMPANY_NAME && isAuthenticated && (
